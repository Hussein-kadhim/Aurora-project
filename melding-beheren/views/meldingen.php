        ...
        <div class="container">
            ...
            <?php else: ?>
                ...
                <div class="controls-row">
                    ...
                    <a href="#" class="btn-primary" onclick="alert('Nieuwe melding toevoegen is nog in ontwikkeling.'); return false;">
                                ...
                                <tbody id="tableBody">
                                    ...
                                    <tr class="melding-row">
                                        ...
                                        <td class="actions-cell">
                                            <a href="#" class="action-btn" title="Melding openen"
                                                onclick="alert('Meldingdetails bekijken is nog in ontwikkeling.'); return false;">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
